...
function setup() {
  ...
  radioFruits.position(165, height);
  ...
  radioFlower.position(260, height);
  ...
  radioImage.position(360, height);
  ...
  newArtButton.position(720, height+5);
  ...
  saveButton.position(720, height+45);  
}
